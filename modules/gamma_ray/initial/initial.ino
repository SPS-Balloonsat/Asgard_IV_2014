...
*/
#define gammaIntPin 5
//value arbitrary and to be changed
...
void setup(){
  ...
  pinMode(gammaIntPin, INPUT);//We don't want pull-up resistors - these
  //should be on the comparator chip, I think. Check?
  attachInterrupt(gammaIntPin, incGamma, RISING);
